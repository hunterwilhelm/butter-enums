 ...
 */
export declare function mapTuple<T extends readonly unknown[], U>(tuple: T, fn: (value: T[number], index: number, array: T) => U): {
    [K in keyof T]: U;
};
/**
 ...
 * ); // Type: [number, string]
 */
export declare function mapTupleWithIndex<T extends readonly unknown[], U extends {
    [K in keyof T]: unknown;
}>(tuple: T, fn: (value: T[number], index: number, array: readonly T[number][]) => any): U;
